...
#include "../../../MusicPlay-master/src/ui/TitleBar/searchlineedit.h"
...
QT_MOC_LITERAL(4, 41, 21) // "slotSendSearchContent"

    },
    "SearchLineEdit\0signalSearchContent\0\0"
    "test\0slotSendSearchContent"
};
...
void SearchLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->slotSendSearchContent(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SearchLineEdit::signalSearchContent)) {
                *result = 0;
                return;
            }
        }
