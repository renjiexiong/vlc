...
#include "../../../MusicPlay-master/src/application/musicplaylist.h"
...
QT_MOC_LITERAL(1, 14, 18), // "removeCurrentMedia"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 11), // "appendMedia"
QT_MOC_LITERAL(4, 46, 7), // "content"
QT_MOC_LITERAL(5, 54, 5) // "items"

    },
    "MusicPlayList\0removeCurrentMedia\0\0"
    "appendMedia\0content\0items"
};
...
void MusicPlayList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->removeCurrentMedia(); break;
        case 1: _t->appendMedia((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->appendMedia((*reinterpret_cast< const QStringList(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MusicPlayList::removeCurrentMedia)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MusicPlayList::removeCurrentMedia()
{
